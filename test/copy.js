...
tape('dDatabase Core Test: Hash copy', function (t) {
  var a = create()
...
tape('dDatabase Core Test: Chaos monkey generated #1', function (t) {
  var ops = []
  ops.push({type: 'append', value: '998'})
  ops.push({type: 'copy', block: 0, from: 'ddb', to: 'clone1'})
  runOps(t, ops)
})

tape('dDatabase Core Test: Chaos monkey generated #2', function (t) {
  var ops = []
  ...
  ops.push({type: 'copy', block: 1, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '982'})
  ops.push({type: 'copy', block: 0, from: 'clone1', to: 'clone2'})
  ops.push({type: 'copy', block: 3, from: 'ddb', to: 'clone1'})
  runOps(t, ops)
})

tape('dDatabase Core Test: Chaos monkey generated #3', function (t) {
  var ops = []
  ...
  ops.push({type: 'copy', block: 5, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 8, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 8, from: 'clone1', to: 'clone2'})
  ops.push({type: 'append', value: '965'})
  ops.push({type: 'copy', block: 6, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 3, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 17, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '947'})
  ops.push({type: 'append', value: '946'})
  ops.push({type: 'copy', block: 18, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '944'})
  ops.push({type: 'copy', block: 22, from: 'ddb', to: 'clone1'})
  runOps(t, ops)
})

tape('dDatabase Core Test: Chaos monkey randomized #4', function (t) {
  var ops = []
  ...
  ops.push({type: 'copy', block: 2, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 16, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 4, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 24, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 9, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 11, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 23, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '384'})
  ops.push({type: 'copy', block: 0, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '380'})
  ops.push({type: 'copy', block: 26, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 29, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '371'})
  ops.push({type: 'copy', block: 15, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 27, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 14, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 46, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 51, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 39, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '271'})
  ops.push({type: 'append', value: '269'})
  ops.push({type: 'copy', block: 45, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '264'})
  ops.push({type: 'copy', block: 51, from: 'clone1', to: 'clone2'})
  ops.push({type: 'append', value: '262'})
  ops.push({type: 'copy', block: 20, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 56, from: 'ddb', to: 'clone1'})
  ops.push({type: 'append', value: '249'})
  ops.push({type: 'append', value: '248'})
  ops.push({type: 'copy', block: 52, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 53, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 49, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 30, from: 'ddb', to: 'clone1'})
  ops.push({type: 'copy', block: 80, from: 'ddb', to: 'clone1'})
  ...
  ops.push({type: 'copy', block: 81, from: 'ddb', to: 'clone1'})
  runOps(t, ops)
})

tape('dDatabase Core Test: Chaos monkey randomized', function (t) {
  var ddb = create()
  var clone1
  var clone2
  var names = ['ddb', 'clone1', 'clone2']
  var runs = 500
  var repro = '  var ops = []\n'

  ddb.ready(function () {
    clone1 = create(ddb.key)
    clone2 = create(ddb.key)
  ...
  function loop () {
    ...
    var from = [ddb, clone1, clone2][(Math.random() * 3) | 0]
    var to = null
  ...
  function name (f) {
    return names[[ddb, clone1, clone2].indexOf(f)]
  }
})
